                ...
                let resultado = `
                    <tr>
                        ...
                        <td class="text-center">
                            <button id="${dados[i].id}" class="btn btn-warning btn-sm btn-view"><i class="mdi mdi-eye"></i></button>
                            <button id="${dados[i].id}" class="btn btn-warning btn-sm btn-edit"><i class="mdi mdi-pencil"></i></button>
